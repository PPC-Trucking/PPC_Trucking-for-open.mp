/*
!     ____  ____  ______   __________  __  __________ __ _____   ________
!    / __ \/ __ \/ ____/  /_  __/ __ \/ / / / ____/ //_//  _/ | / / ____/
!   / /_/ / /_/ / /        / / / /_/ / / / / /   / ,<   / //  |/ / / __  
!  / ____/ ____/ /___     / / / _, _/ /_/ / /___/ /| |_/ // /|  / /_/ /  
! /_/   /_/    \____/    /_/ /_/ |_|\____/\____/_/ |_/___/_/ |_/\____/   

 * PPC_Trucking converted to work on open.mp and with MySQL+Bcrypt
 */
...
#include "source\PPC_DefTexts"
#include "source\PPC_ServerSettings"
#include "source\PPC_Defines"
#include "source\PPC_DefLocations"
#include "source\PPC_DefLoads"
#include "source\PPC_DefCars"
#include "source\PPC_DefPlanes"
#include "source\PPC_DefTrailers"
#include "source\PPC_DefBuyableVehicles"
// Include functions for this gamemode
#include "source\PPC_AutoEvict"
#include "source\PPC_GlobalTimer"
#include "source\PPC_Common"
#include "source\PPC_Housing"
#include "source\PPC_Business"
#include "source\PPC_GameModeInit"
#include "source\PPC_FileOperations"
#include "source\PPC_Database"
#include "source\PPC_Speedometer"
#include "source\PPC_MissionsTrucking"
#include "source\PPC_MissionsBus"
#include "source\PPC_MissionsPilot"
#include "source\PPC_MissionsPolice"
#include "source\PPC_MissionsMafia"
#include "source\PPC_MissionsAssistance"
#include "source\PPC_MissionsCourier"
#include "source\PPC_MissionsRoadworker"
#include "source\PPC_Convoys"
#include "source\PPC_Dialogs"
#include "source\PPC_PlayerCommands"
#include "source\PPC_PlayerCommandsAliases"
#include "source\PPC_Toll"
...
main()
{
	...
	print("Version 1.3.0");
	print("https://github.com/PPC-Trucking/PPC_Trucking-for-open.mp");
	print("----------------------------------\n");
}
...
public OnGameModeInit()
{
	...
	ShowNameTags(true); // Show player names (and health) above their head
	ManualVehicleEngineAndLights(); // Let the server control the vehicle's engine and lights
	EnableStuntBonusForAll(false); // Disable stunt bonus for all players
...
public OnPlayerConnect(playerid)
{
	...
	TextDrawAlignment(APlayerData[playerid][MissionText], TEXT_DRAW_ALIGN_CENTER ); // Align the missiontext to the center
...
public OnPlayerDisconnect(playerid, reason)
{
	    ...
	    if (IsPlayerConnected(i)) // Check if the player is connected
	        if (GetPlayerState(i) == PLAYER_STATE_SPECTATING) // Check if this player is spectating somebody
	            if (APlayerData[i][SpectateID] == playerid) // Check if this player is spectating me
		   		{
					TogglePlayerSpectating(i, false); // Turn off spectate-mode
	...
	APlayerData[playerid][LastInterestTime] = 0;
		...
		case ClassPolice: // Police class
		{
			...
			if (PoliceGetsWeapons == true)
			{
				...
				for (new i; i < sizeof(APoliceWeapons); i++)
				    GivePlayerWeapon(playerid, WEAPON:APoliceWeapons[i], PoliceWeaponsAmmo);
			}
		}
...
public OnPlayerRequestSpawn(playerid)
{
	...
	SetSpawnInfo(playerid, 0, GetPlayerSkin(playerid), x, y, z, Angle, WEAPON_FIST, 0, WEAPON_FIST, 0, WEAPON_FIST, 0);
...
public OnVehicleSpawn(vehicleid)
{
	...
	ChangeVehicleColours(vehicleid, AVehicleData[vehicleid][Color1], AVehicleData[vehicleid][Color2]);
